...
discussed here; PI control technique has been
suggested for voltage and reactive power
injection followed by the hysteresis band current
controller. The hysteresis band current controller is
used to control the STATCOM current. The STATCOM is found to be efficient technology compared to the conventional methods of reactive power compensation.
