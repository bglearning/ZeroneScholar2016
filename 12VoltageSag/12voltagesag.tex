...
\DeclareGraphicsExtensions{.png,.jpeg,.pdf,.jpg}
\usepackage{amsmath}
...
\usepackage{url}
    ...
    \IEEEauthorblockA{Department of Electrical Engineering \\Institute of Engineering, Pulchowk Campus, Lalitpur, Nepal \\
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bp}}]{Bibek Pandey} is the student of Electrical Engineering programme at Pulchowk Campus and will be completing his Bachelor's Degree by 2016. He is currently working on research project on Power Quality Improvement based on Dynamic Voltage Restoring technique. His  research interests lie on Electrical Power Quality Improvement, Electrical Power Transmission and Distribution Designing and Renewable Energy.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bk}}]{Bibek K.C.} is working towards his Bachelor's degree in Electrical Engineering programme at Tribhuwan University, IoE, Pulchowk Campus and will graduate by 2016. He is currently working on research project on Power Quality Improvement based on Dynamic Voltage Restoring technique. His  research interests lie on Artificial Intelligence based Power Quality Improvement, Smart Grid and Load Management.
\end{IEEEbiography}
\newpage
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pks}}]{Pawan Kumar Shah} is an undergraduate student of Electrical Engineering at Pulchowk Campus, IoE, Tribhuwan University and will be graduated by 2016.  His Undergraduate research project was Power Quality Improvement by Dynamic Voltage Restorer. His  research interests lie on Electrical Energy System Management, Demand Side Management, Power System and Power Electronics.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{ss}}]{Saroj Sapkota}  is an undergraduate student of Electrical Engineering at Tribhuwan University, IoE, Pulchowk Campus and will be graduated by 2016.  His undergraduate research project was based on Power Quality Improvement by Dynamic Voltage Restorer. His research interests lie on Electrical Power Transmission and Distribution, Demand Side Management, Power Quality Improvement and Power Electronics.
\end{IEEEbiography}
